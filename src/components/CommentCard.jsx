...
function CommentCard({ comment, threadId }) {
  ...
  const onUpVote = () => {
    if (isUpVoted) {
      dispatch(asyncNeutralVoteCommentDetail(threadId, comment.id));
    } else {
      dispatch(asyncUpVoteCommentDetail(threadId, comment.id));
    }
  };
  ...
  const onDownVote = () => {
    if (isDownVoted) {
      ...
      dispatch(asyncDownVoteCommentDetail(threadId, comment.id));
    }
  };
